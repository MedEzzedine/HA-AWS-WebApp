...
variable "vpc_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "WebApp-vpc", "created-by" = "terraform" }
}
...
variable "asg_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "WebApp-asg-sg", "created-by" = "terraform" }
}
...
variable "asg_iam_role_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "WebApp-asg-iam-role", "created-by" = "terraform" }
}
...
variable "asg_instance_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "WebApp-asg-instance", "created-by" = "terraform" }
}

variable "asg_volume_tags" {
  description = "Auto scaling group volume tags"
  type        = map(string)
  default     = { "Name" = "WebApp-asg-volume", "created-by" = "terraform" }
}

variable "asg_tags" {
  description = "Auto scaling group tags"
  type        = map(string)
  default     = { "Name" = "WebApp-asg", "created-by" = "terraform" }
}
...
variable "alb_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "WebApp-alb-sg", "created-by" = "terraform" }
}
...
variable "alb_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "WebApp-alb", "created-by" = "terraform" }
}
